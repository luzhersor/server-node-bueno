...
// Permite la carga de recursos locales desde scripts ejecutados en un contexto web
//app.use('/static', express.static('C:\\Users\\luz.soriano\\Downloads'));
//app.use('/static', express.static(path.join(__dirname, 'C:\\Users\\luz.soriano\\Downloads')));
...
app.post('/checkStringInFiles', (req, res) => {
  ...
  res.json(result);
  console.log(result)
  console.log("Recibio los parametros")
});
